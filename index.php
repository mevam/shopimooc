...
if (!($cates&&is_array($cates))){
    alertMes("网站维护中！！！","http://www.melonydi.cn");
}
?>
<!doctype html>
<html>
...
<div class="shopList comWidth clearfix">
    ...
    <div class="rightArea">
        <div class="shopList_top clearfix">
            ...
            <div class="shop_item">
                <div class="shop_img">
                    <a href="proDetails.php?id=<?php echo $pro['id'];?>" target="_blank"><img width="187px" height="200px" src="image_220/<?php echo $proImg['albumPath'];?>" alt=""></a>
                </div>
        ...
        <div class="shopList_sm clearfix">
            ...
            <div class="shopItem_sm">
                <div class="shopItem_smImg">
                    <a href="proDetails.php?id=<?php echo $proSmall['id'];?>" target="_blank"><img width="95px" height="95px" src="image_220/<?php echo $proSmallImg['albumPath'];?>" alt=""></a>
                </div>
