...
$id=$_REQUEST['id'];
$sql="select id,username,password,email,face from imooc_admin where id='{$id}'";
$row=fetchOne($sql);
?>
<!DOCTYPE html>
<html>
...
<body>
<h3>编辑用户</h3>
<form action="doAdminAction.php?act=editUser" method="post" enctype="multipart/form-data">
